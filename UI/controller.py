...
class Controller:
    ...
    def handleCreaGrafoPesato(self):
        ...
        self._view.lst_result.controls.append(f"Il grafo ha {nNodes} nodi")
        self._view.lst_result.controls.append(ft.Text(f"Il grafo ha {nEdges} archi"))
    ...
    def handleCercaRaggiungibili(self, e):
        #visited = self._model.getBFSNodes(self.handleCreaGrafo)
        visited = self._model.getDFSNodes(self._fermataPartenza)
        self._view.lst_result.controls.clear()
        self._view.lst_result.controls.append(ft.Text(f"Dalla stazione {self._fermataPartenza} posso"
                                                      f"raggiungere {len(visited)} stazioni"))
        for v in visited:
